...
public interface DocumentRepository extends JpaRepository<DocumentEntity, Long> {
    Optional<DocumentEntity> findByVarcodeIdAndRevisionDoc(String id, Long revisionDoc); // 해당 코드의 최신 문서 찾기
    Page<DocumentEntity> findByVarcodeId(String id, Pageable pageable); // 바코드 찾기(페이징)
    ...
    Long countByVarcodeId(String id); // 등록된 코드 정보 카운팅
}
